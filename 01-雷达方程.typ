...
#figure(
  table(
    ...
    [3Hz], [#l3 km], table.cell(rowspan: 2)[HF], table.cell(rowspan: 3)[A],
    [8GHz], [#eval(g8)mm], table.cell(rowspan: 3)[X], [I],
    [3MHz], [#eval(m3)m],
    [10GHz], [#eval(g10)mm], table.cell(rowspan: 4)[J],
    [30MHz], [#eval(m30)m], table.cell(rowspan: 2)[VHF],
    [12GHz], [#eval(g12)mm],
    [250MHz], [#eval(m250)m], table.cell(rowspan: 2)[B],
    [18GHz], [#eval(g18)mm], [Kᵤ],
    [300MHz], [#eval(m300)m], table.cell(rowspan: 2)[UHF],
    [20GHz], [#eval(g20)mm], table.cell(rowspan: 2)[K],
    [500MHz], [#eval(m500)m], [C],
    [27GHz], [#eval(g27)mm], table.cell(rowspan: 3)[K],
    [1GHz], [#eval(g1)m], [L], [D],
    [30GHz], [#eval(g30)mm], table.cell(rowspan: 2)[Kₐ],
    [2GHz], [#eval(g2)m], table.cell(rowspan: 2)[S], [E],
    [40GHz], [#eval(g40)mm],
    [3GHz], [#eval(g3)m], [F],
    [60GHz], [#eval(g60)mm], table.cell(rowspan: 2)[V], [L],
    [4GHz], [#eval(g4)mm], table.cell(rowspan: 2)[C], [G],
    [75GHz], [#eval(g75)mm], table.cell(rowspan: 2)[M],
    [6GHz], [#eval(g6)mm], [H],
